...
type View = 'list' | 'create' | 'detail' | 'edit' | 'admin'
            ...
            <div className="flex items-center gap-4">
              {user.is_admin && (
                <button
                  ...
                  className="text-sm text-forest-200 hover:text-white flex items-center gap-1"
                >
            ...
            {view === 'list' && (
              <div>
                <div className="flex justify-between items-center mb-6">
                  ...
                  {(user.is_admin || user.can_create_events) && (
                    <button
